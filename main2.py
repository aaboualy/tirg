...
def SaveFilesFeatures():
  ...
  # all_queries=[]
  # with open(Path1+r'/dataset172'+r"/"+'test.txt', 'wb') as fp:
  #     pickle.dump(all_queries, fp)
  # with open(Path1+r'/dataset33'+r"/"+'test.txt', 'wb') as fp:
  #     pickle.dump(all_queries, fp)
